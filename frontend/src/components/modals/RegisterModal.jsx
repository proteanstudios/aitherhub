...
export default function RegisterModal({ open, onClose, onSwitchToLogin }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center">
      ...
      <div className="relative mt-[123px] mb-[100px] mx-auto w-[92vw] max-w-[428px] aspect-[428/569] rounded-xl md:mt-[150px] md:mb-0 md:mx-0 md:w-[700px] md:h-[569px] md:max-w-none md:aspect-auto  md:opacity-100">  
        <button
          onClick={onClose}
        ...
        <div className="p-6 w-full mt-[69px] mr-[6px] bg-white rounded-[10px]">
